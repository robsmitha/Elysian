...
namespace Elysian.Migrations
{
    ...
    [Migration("20250711021320_AddDayOfMonthDue")]
    partial class AddDayOfMonthDue
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elysian.Domain.Data.IncomePayment", b =>
                {
                    b.Property<int>("IncomePaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("IncomePaymentId"));
                    ...
                    b.HasKey("IncomePaymentId");

                    b.HasIndex("IncomeSourceId");

                    b.ToTable("IncomePayment", (string)null);

                    b.HasAnnotation("Finbuckle:MultiTenant", true);
                });

            modelBuilder.Entity("Elysian.Domain.Data.IncomeSource", b =>
                {
                    b.Property<int>("IncomeSourceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("IncomeSourceType")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Elysian.Domain.Data.InstitutionAccessItemUser", b =>
                {
                    b.Property<int>("InstitutionAccessItemUserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("InstitutionAccessItemUserId"));
                    ...
                    b.HasKey("InstitutionAccessItemUserId");

                    b.HasIndex("InstitutionAccessItemId");

                    b.HasIndex("UserId");

                    b.ToTable("InstitutionAccessItemUser", (string)null);
            ...
            modelBuilder.Entity("Elysian.Domain.Data.User", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elysian.Domain.Data.IncomePayment", b =>
                {
                    b.HasOne("Elysian.Domain.Data.IncomeSource", "IncomeSource")
            ...
            modelBuilder.Entity("Elysian.Domain.Data.IncomeSource", b =>
                {
                    ...
                    b.OwnsMany("Elysian.Domain.Data.ExpectedPaymentMemo", "ExpectedPaymentMemos", b1 =>
                        {
                            ...
                            b1.ToTable("IncomeSource");

                            b1.ToJson("ExpectedPaymentMemos");

                            b1.WithOwner()
                                .HasForeignKey("IncomeSourceId");
                        });

                    b.Navigation("ExpectedPaymentMemos");
            ...
            modelBuilder.Entity("Elysian.Domain.Data.InstitutionAccessItemUser", b =>
                {
                    ...
                    b.HasOne("Elysian.Domain.Data.User", "User")
                        .WithMany("InstitutionAccessItemUsers")
            ...
            modelBuilder.Entity("Elysian.Domain.Data.User", b =>
                {
                    b.OwnsOne("Elysian.Domain.Data.AccessControl", "AccessControl", b1 =>
                        {
                            b1.Property<int>("UserId")
                                .HasColumnType("int");

                            b1.Property<string>("Policies")
                                .IsRequired()
                                .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Elysian.Domain.Data.User", b =>
                {
                    b.Navigation("InstitutionAccessItemUsers");
                });
