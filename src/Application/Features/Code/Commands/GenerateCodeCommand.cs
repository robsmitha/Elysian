...
{
    public record GenerateCodeCommand(CodeGenerationRequest CodeGenerationOptions) : IRequest<CodeGenerationResponse>;
    public class GenerateCodeCommandHandler() : IRequestHandler<GenerateCodeCommand, CodeGenerationResponse>
    {
